...
var id2Text = " NGMA -:-";
var id2Len = id2Text.length;
const id2FilledArr = randTitle().split('').splice(0,id2Len);

var id3Text = "-:- NGMA ";
var id3Len = id3Text.length;
const id3FilledArr = randTitle().split('').splice(0,id3Len);

var id4Text = " ENGLISH -:-";
var id4Len = id4Text.length;
const id4FilledArr = randTitle().split('').splice(0,id4Len);
...
function typeWriter() {
    if (ch < prcText.length) {
		...
		var id2letter = id2Text.charAt(ch);
		var id3letter = id3Text.charAt(ch);
        ...
        id2FilledArr.splice(ch,1,id2letter);
        id3FilledArr.splice(ch,1,id3letter);
        ...
        document.getElementById("id2").innerHTML = id2FilledArr.join('');
        document.getElementById("id3").innerHTML = id3FilledArr.join('');
        document.getElementById("id4").innerHTML = id4FilledArr.join('');
        ch++;
